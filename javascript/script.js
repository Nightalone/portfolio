function aparacerDescricao(app){
    if(app == 'calculadora'){
        ...
        document.querySelector("#informacoesFood").innerHTML = "E-commerce de hamburguers, responsivo para celulares, no momento estou trabalhando nesse projeto ele náo está finalizado. <br> Tecnologias usadas: HTML, CSS, JavaScript e React."
    }
}
